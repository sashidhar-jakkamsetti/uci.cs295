...
uint32_t dfa_init(const uint32_t main_start, const uint32_t main_end, const uint8_t *user_data, const int user_data_len);

// mLBolus = 3 + 2;
// dfa_primevariable_checker(1, (void *)&mLBolus, sizeof(mLBolus), "f:bolus, v:mLBolus", 19, (char)DEF);
