...
2. Add "scrt " in the beginning of line 33,34,40,41 of syringePumpSim.c to test the script.
...
# Assumes that secret variable is always declared as scrt followed by variable declaration. 
